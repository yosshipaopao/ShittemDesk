...
@export_category("Sky")
@export var sky_top_color : Gradient = Gradient.new()
@export var sky_hirizon_color : Gradient = Gradient.new()
@export var ground_horizon_color : Gradient = Gradient.new()
@export var ground_bottom_color : Gradient = Gradient.new()
...
func _process(delta):
	...
	# sky
	world_environment.environment.sky.sky_material.set("sky_top_color", sky_top_color.sample(_time))
	world_environment.environment.sky.sky_material.set("sky_horizon_color", sky_hirizon_color.sample(_time))
	world_environment.environment.sky.sky_material.set("ground_horizon_color", ground_horizon_color.sample(_time))
	world_environment.environment.sky.sky_material.set("ground_bottom_color", ground_bottom_color.sample(_time))
